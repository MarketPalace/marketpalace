...
use App\Containers\MarketPalace\Category\Contracts\Taxon as TaxonContract;
use App\Containers\MarketPalace\Category\Contracts\Taxonomy as TaxonomyContract;

class Taxon extends ParentModel implements TaxonContract
{
    use Sluggable;
     ...
     */
    protected string $resourceKey = 'Taxon';
