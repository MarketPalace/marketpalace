...
trait HasPropertyFilter
{
    ...
    private static string $propertyProxyClass = '\\MarketPalace\\Properties\\Models\\PropertyProxy';
    ...
    private function fetchProperty(): ?object
    {
        if (null !== self::$propertiesModelClass) {
            ...
            if (!class_exists($proxyClass)) {
                throw new Exception('The properties module is missing. Use `composer req marketpalace/properties` to install it.');
            }
